            ...
            <div className="container flex flex-col justify-center max-w-[1280px] py-8 mx-auto md:p-8 text-left">
                <div className="flex flex-col md:flex-row items-start justify-start mb-8">
                    ...
                    <div className="md:basis-4/5">
                        <div className="w-full mx-auto space-y-4 bg-white p-8 rounded border border-stone-300">
                            {faq.map((block) => (
                                <details key={block.id} className="w-full py-4 text-stone-800 border-b hover:cursor-pointer group last:border-b-0 border-stone-300">
