  ...
  return (
    <div id="membership" className="text-center">
        ...
        <div className="flex flex-col text-center">
            <p className="font-merriweather font-semibold text-lg tracking-wide text-stone-800 mb-8">BENEFITS</p>
            <div className="flex flex-row mx-auto gap-6 flex-wrap items-center justify-center">
                {membershipBenefits.map((benefit) => (
                    <div className="w-[275px] self-stretch flex flex-col rounded justify-center items-center border-stone-200 border-2 hover:border-blue-500 hover:border-2">
                        ...
                        <p key={benefit.id} className="text-md font-lato font-normal text-stone-800 p-6">{benefit.text}</p>
                    </div>
                ))}
            </div>
            <p className="font-semibold text-lg text-stone-800 tracking-wide my-8">REQUIREMENTS</p>
            <div className="flex flex-row mx-auto gap-4 flex-wrap items-center justify-center mb-8">
                {membershipRequirements.map((benefit) => (
                    ...
                    <p key={benefit.id} className="text-md font-lato font-normal">{benefit.text}</p>
                    </div>
                ))}
            </div>
